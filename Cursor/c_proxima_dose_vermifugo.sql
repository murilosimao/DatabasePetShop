DECLARE
    CURSOR cur_idCachorro IS SELECT IDCACHORRO, VERMIFUGO_2_DOSE+365 FROM TB_CACHORRO_DETALHE WHERE VERMIFUGO_2_DOSE+365 = SYSDATE;
...
BEGIN
    ...
    EXIT WHEN cur_idCachorro%NOTFOUND;
        ...
        IF v_id IS NOT NULL THEN
            BEGIN
            send_mail_test.mail_test('murilo.m.simao@gmail.com',  'Campanha de Fermifugação', 'ID = ' || v_id || ' Proxima data = '|| v_prox_data);
            END;
        END IF;  
